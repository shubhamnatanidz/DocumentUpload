...
public class FileControllerTest extends AbstractTest {
    ...
    public void testFileById() throws Exception {
        UploadDocument expected = fileRepository.save(new UploadDocument()
                .toBuilder().name(RandomStringUtils
                        .randomAlphabetic(10))
                .uploadBy(adminUser.getId())
                .totalRecords(10)
    ...
    public void testListFiles() throws Exception {
        ...
        List<UploadDocument> list = IntStream.range(0, randomNo).mapToObj(value -> new UploadDocument()
                .toBuilder().name(RandomStringUtils
                        .randomAlphabetic(10))
                .uploadBy(adminUser.getId())
                .totalRecords(10)
    ...
    public void testDeleteById() throws Exception {
        ...
        String uri = "/files/delete/" + expected.getId();
        mvc.perform(MockMvcRequestBuilders.delete(uri).contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)).andExpect(MockMvcResultMatchers.status().isOk());

        Optional<UploadDocument> byId = fileRepository.findById(expected.getId());
